...
GLfloat emission_P1[4] = {0.3, 0.0, 0.0, 0.0};
...
void Beam::draw() {
	...
	glBegin(GL_QUADS); {
		...
		glVertex3f(x-ante_dir[0]/2.0, y-ante_dir[1]/2.0, H_BEAM);
		glVertex3f(x-ante_dir[0]/2.0, y-ante_dir[1]/2.0, 0.0);
		glEnd();}
	glBegin(GL_QUADS); {
		glVertex3f(x, y, 0.0);
		glVertex3f(x, y, H_BEAM);
		glVertex3f(x+post_dir[0]/2.0, y+post_dir[1]/2.0, H_BEAM);
		glVertex3f(x+post_dir[0]/2.0, y+post_dir[1]/2.0, 0.0);
		glEnd();}
}
